...
class Paziente(UtenteBase):
    ...
    referente_adulto = models.CharField(max_length=100, blank=True, null=True, help_text="Nome e cognome del referente adulto per i minori di 14 anni")
    ...
    def clean(self):
        ...
        if self.is_minor() and not self.referente_adulto:
            from django.core.exceptions import ValidationError
            raise ValidationError({'referente_adulto': 'Il referente adulto è obbligatorio per i minori di 14 anni.'})
